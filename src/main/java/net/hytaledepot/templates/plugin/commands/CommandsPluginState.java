...
public final class CommandsPluginState {
  private final AtomicReference<CommandsPluginLifecycle> lifecycle = new AtomicReference<>(CommandsPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Commands";
  private volatile String dataDirectory = "";

  public CommandsPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(CommandsPluginLifecycle next) {
    lifecycle.set(next);
  }
